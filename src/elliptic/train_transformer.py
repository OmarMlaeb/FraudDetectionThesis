...
def train(seed=42):
    ...
    best_model_path = f"results/best_elliptic_transformer_seed{seed}_model.pt"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train Elliptic Transformer baseline.")
